            ...
            <div className="flex flex-col gap-6 mt-6">
              {visibleProfiles.map((profile) => (
                <Link
                  ...
                  className="flex items-start gap-4 bg-gradient-to-br from-white/10 to-white/5 border border-white/10 rounded-2xl p-4 hover:scale-[1.01] transition duration-200 shadow-md hover:shadow-xl"
                >
                  ...
                  <div className="flex flex-col w-full">
                    ...
                    <div className="text-sm text-white/70 whitespace-pre-line leading-relaxed">{profile.description}</div>
                    <div className="text-xs text-gray-400 mt-1">@{profile.username}</div>
                  </div>
                </Link>
              ))}
            </div>
