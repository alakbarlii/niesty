    ...
    <section className="p-6 md:p-12">
      <div className="flex flex-col gap-6 max-w-3xl mx-auto">
        <div className="flex flex-col gap-4 pt-10 mb-2">
          <h1 className="text-3xl font-extrabold text-white tracking-tight mb-3">Search</h1>
          <div className="relative w-full max-w-xl">
            <input
              ...
              placeholder="Search..."
              className="w-full rounded-full border px-5 py-3 pr-14 left-4 text-lg bg-black/40 backdrop-blur-sm text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-white"
            />
